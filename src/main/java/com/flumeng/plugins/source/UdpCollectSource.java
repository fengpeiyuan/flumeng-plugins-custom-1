...
public class UdpCollectSource extends AbstractSource implements EventDrivenSource, Configurable {
  private String    host;
  private int       port;
  ...
  private static final Logger logger = LoggerFactory.getLogger(UdpCollectSource.class);
